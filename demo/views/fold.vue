...
const test = throttle((val: string) => {
  console.log(val)
}, 200)
test('hello world')
...
console.log(new Time().add(1, 'month').getTime(), new Time().getTime())
</script>
